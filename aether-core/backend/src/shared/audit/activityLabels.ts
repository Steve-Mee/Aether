...
export const ACTION_LABELS: Record<string, string> = {
  ...
  brain_tool_proposed: 'Brein-tool voorstel',
  brain_tool_called: 'Brein-tool aangeroepen',
  brain_approval_created: 'Brein-goedkeuring aangemaakt',
  brain_tool_auto_executed: 'Brein-tool automatisch uitgevoerd',
  brain_tool_executed: 'Brein-tool uitgevoerd',
  brain_tool_rejected: 'Brein-tool afgewezen',
