...
import type { SupplierOverviewPort } from '../../application/ports/SupplierOverviewPort';
import {
  auditSupplierId,
  daysAgo,
  deriveMonitoringLabel,
  isImportantChange,
  isPriceDrop,
  parseAuditDetails,
  startOfMonth,
  syncSourceFromActor,
} from '../../application/services/supplierOverviewHelpers';
import type {
  SupplierDetailResponse,
  SupplierOverviewResponse,
  SupplierOverviewRow,
  SupplierSyncHistoryItem,
} from '../../application/services/supplierOverviewTypes';

export class PrismaSupplierOverviewAdapter implements SupplierOverviewPort {
